...
const FormPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Send data to the server (Webhook)
      await fetch("https://hkdk.events/gpxuv3t1p1c23x", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
      ...
      // Send data to your email via EmailJS
      // await emailjs.send(
      //   "service_49sjwjf", // Your EmailJS Service ID
      //   "template_s4z0rd3", // Your EmailJS Template ID
      //   {
      //     name: data.name,
      //     phone: data.phone,
      //     refurl: data.refurl,
      //     source: data.source,
      //     email: "shubhamkumar83216@gmail.com", // Your email address to receive the details
      //   },
      //   "Yb63QhkZdjQKTtjrX" // Your EmailJS public key
      // );
