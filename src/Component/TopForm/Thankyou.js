    ...
    <div className="flex items-center justify-center ">
      <div className="bg-white rounded-lg  max-w-lg w-full text-center">
        <h2 className="text-3xl md:text-3xl font-bold text-gray-700">
          ...
          <p className="text-lg md:text-xl font-semibold text-gray-700">You’ve Unlocked an Exclusive Discount!</p> 
        </h2>
        <p className="text-gray-500 mt-4 text-sm md:text-base">
          Your special offer is now active! But hurry—this extra discount is valid only for the next <strong>10 minutes</strong>! ⏳<br/>📞
        ...
        <div className="mt-6 flex flex-col md:flex-row justify-center gap-4">
          ...
          <a
            ...
            className="bg-green-500 text-white py-3 px-6 rounded-lg font-semibold w-full md:w-auto text-center hover:bg-green-600 transition duration-300"
          >
           WhatsApp Now
          </a>
        </div>
